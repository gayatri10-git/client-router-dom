  ...
  return (
    <div>
      ...
      <div class='flex flex-wrap items-center gap-4 max-w-7xl mx-auto w-full'>
        <NavLink href="javascript:void(0)" class="max-sm:hidden"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" class='w-[134px]' />
        </NavLink>
        <NavLink href="javascript:void(0)" class="hidden max-sm:block"><img src="https://readymadeui.com/readymadeui-short.svg" alt="logo" class='w-8' />
        </NavLink>
