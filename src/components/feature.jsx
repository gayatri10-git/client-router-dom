...
function ComponentName() {
  return (
    <div>
      <div class="bg-linear-to-r from-purple-800 to-indigo-800 py-12 px-4">
          <div class="max-w-7xl mx-auto">
              <div class="max-w-3xl mx-auto mb-16 text-center">
                  <h2 class="text-white text-3xl md:text-4xl font-bold text-center mb-4 md:leading-[45px] leading-10">Discover Our Exclusive Features</h2>
